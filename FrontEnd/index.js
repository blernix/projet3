        ...
        function displayHandband() {
          ...
          if (token != null) {
            ...
            const iconeModifier = document.createElement('i');
                  iconeModifier.classList.add('fas', 'fa-pencil-alt'); 
            ...
            lienDeconnexion.innerText = 'Déconnexion';
            ...
            bandeau.appendChild(lienEdition);
            bandeau.appendChild(boutonPublier);
            bandeau.appendChild(lienDeconnexion);
                        ...
                        function openModal() {
                          if (modalOpen) {
                            ...
                            modalOpen = true;
                                ...
                                // });
                                // window.addEventListener("click", (event) => {
                                //   if (event.target.closest(".modal") && event.target.closest(".modal-add") !== modal) {
                                //     closeModal();
                                //   }
                                // });
                                // function closeModal() {
                                ...
                                function loadWorksModal(works) {
                                        ...
                                        async function fetchCategoriesModal() {
                                            ...
                                            function openAddPhotoModal() {
                                                ...
                                                addPhotoModalHeader.insertBefore(backButton, addPhotoModalTitle);
                                                ...
                                                fileInput.classList.add("file-add")
                                                fileInput.type = "file";
                                                ...
                                                titleInput.addEventListener("change", checkFieldsValidity);
                                                ...
                                                addPhotoModalFooter.classList.add("modal-footer");
                                                 ...
                                                 savePhotoButton = document.createElement("button");
                                                ...
                                                function handleFileSelection(event) {
                                                      ...
                                                      console.log(titleFilled);
                                                        if (fileFilled && titleFilled) {
                                                          savePhotoButton.classList.add("btn-add--filled"); // Ajoutez une classe CSS pour changer la couleur du bouton
                                                        } else {
                                                          savePhotoButton.classList.remove("btn-add--filled"); // Supprimez la classe CSS si un champ est vide
                                                        }
                                                      }
                                                      const previewImageDisplayed = previewImage.src && previewImage.src !== 'about:blank';

                                                      if (previewImageDisplayed && titleFilled) { 
                                                        savePhotoButton.classList.add("btn-add--filled"); // Ajouter une classe CSS pour changer la couleur du bouton
                                                      } else {
                                                        savePhotoButton.classList.remove("btn-add--filled"); // Supprimer la classe CSS si l'aperçu de l'image est vide ou si le champ titre est vide
                                                      }
                                                      
                                                      checkFieldsValidity(); // Vérifie les champs initialement
                                              ...
                                              function savePhoto() {
                                                    ...
                                                    if (!title) {
                                                      errorMessage = "Veuillez saisir un titre pour la photo.";
                                                    }
